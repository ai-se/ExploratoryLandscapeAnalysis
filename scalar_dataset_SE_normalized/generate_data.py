...
def get_columns(filename):
    ...
    content_raw = pd.read_csv(filename)
    content = (content_raw - content_raw.min()) / (content_raw.max() - content_raw.min() + 0.00001)
    ...
    for i in xrange(50):
        ...
        df.to_csv("../scalar_dataset_SE_normalized/" + e_name + "_" + str(i) + ".csv", index=False)
